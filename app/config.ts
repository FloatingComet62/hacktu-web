...
export const TRACKS = [
  ...
  t("Sustainable Ecosystems", "Design systems that help industries and cities grow without hurting nature. Build solutions to optimize resource usage, monitor wildlife health, or create eco-friendly infrastructure. The goal is to support modern living while actively protecting the land around us.", "SDG 12 & 17"),
...
export const NORMAL_SPONSOR = "Normal Sponsor";
export const SPONSORS = {
  "Hackathon Sponsor": [
    s("/sponsors/MLH.png", "https://mlh.io/", "Major League Hacking"),
  ],
  "Platform Partner": [
